...
//Purchase Order Mgmt ocmod code

            $purchaseOrder_link = $this->load->controller('extension/module/oc_pom/pom_columnLeft');


            if (isset($purchaseOrder_link['title']) && isset($purchaseOrder_link['link'])) {

                $data['menus'][] = array(

                    'id'       => 'menu-purchase-order',

                    'icon'     => 'fa-shopping-cart',

                    'name'     => $purchaseOrder_link['title'],

                    'href'     => '',

                    'children' => $purchaseOrder_link['link']
