...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
        ...
        $data['suppliers'] = $this->model_po_mgmt_po_supplier->getSuppliersForFilters();
	...
	protected function getForm() {
        ...
        if (isset($this->error['cost_price'])) {
            $data['error_cost_price'] = $this->error['cost_price'];
        } else {
            $data['error_cost_price'] = '';
        }
        ...
        $data['suppliers'] = $this->model_po_mgmt_po_supplier->getSuppliers();
	...
	protected function validateForm() {
        ...
        if ((float)$this->request->post['cost_price'] >=  (float)$this->request->post['price']) {
            $this->error['cost_price'] = $this->language->get('error_cost_price');
        }
